...
def package():
    """Package Paella Utilities UI into a standalone executable using PyInstaller."""
    print("Starting Paella Utilities packaging process...")
    ...
    spec_file = os.path.join("references", "utilities.spec")
    ...
    try:
        ...
        print("The executable can be found in the 'dist' folder as 'Paella_utilities'.")
